(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Griddle"] = factory(require("react"), require("lodash"));
	else
	...
	*/
	...
	var CustomPaginationContainer = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(that.props.customPagerComponent, { count: this.props.count, maxPage: this.props.maxPage, nextText: this.props.nextText, previousText: this.props.previousText, currentPage: this.props.currentPage, setPage: this.props.setPage, previous: this.props.previous, next: this.props.next });
	  }
	});
